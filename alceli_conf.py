...
#     'injection_energy': 50.,     # [MeV] eKin-in
#     'quad_gradient': 16.0,       # [T/m] DB/dr
#     'emitx_i': 1.0,              # [mm*mrad] emittance-x @ entrance
#     'emity_i': 1.0,              # [mm*mrad] emittance-y @ entrance
#     'emitz_i': 0.24153,          # [sec*eV] emittance-z @ entrance
#     'betax_i': 0.780,            # [m] twiss betax @ entrance
#     'betay_i': 2.373,            # [m] twiss betax @ entrance
#     'betaz_i': 0.5844,           # [m] twiss betaz @ entrance
#     'alfax_i': 0.0,              # twiss alphax @ entrance
#     'alfay_i': 0.0,              # twiss alphaxy @ entrance
#     'alfaz_i': 0.0196,           # twiss alphaxz @ entrance
